...
const ActivationPage = () => {
    ...
    return (
        <div>
            ...
            <h2 className='text-white text-center font-bold text-2xl mt-12 uppercase'>Activation Page</h2>
        <div className='container flex flex-col justify-center items-center w-full h-[30rem]'>
            <div className='ms-12'>
                        ...
                        {isLoading && (
                            ...
                            <div className='text-mindaro flex flex-col items-center'>
                                Please wait...
                                </div>
                            ...
                            <div className='w-full flex flex-col justify-center items-center'>
                                ...
                                <img src='https://media.discordapp.net/attachments/1018124413176135700/1227129402442256477/wired-outline-1140-error.gif?ex=66274850&is=6614d350&hm=b647df4af132f14dd37e6b98de6169d58f41ca887866f11f6d1907d8256d3338&=&width=670&height=670' className='' width={200} alt='error' />
                                </div>
                    )}
                                </div>
            </div>
